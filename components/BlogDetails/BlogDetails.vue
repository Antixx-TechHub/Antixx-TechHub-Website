                        ...
                        <div class="article-content">
                            <div class="entry-meta">
                                <ul>
                                    ...
                                    <!-- <li><i class="ri-message-2-line"></i><NuxtLink to="/blog-grid">(4) Comments</NuxtLink></li> -->
                                </ul>
                            </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="single-blog-post">
                                        ...
                                        <div class="content">
                                            ...
                                            <h3><NuxtLink to="/blog-details">Branding involves developing strategy to create a point of differentiation</NuxtLink></h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="single-blog-post">
                                        ...
                                        <div class="content">
                                            <ul class="meta">
                                                ...
                                                <li><i class="ri-message-2-line"></i> <NuxtLink to="/blog-details">(4) Comment</NuxtLink></li>
                                            </ul>
                                            <h3><NuxtLink to="/blog-details">Design is a plan or specification for the construction of an object</NuxtLink></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-12">
                    <aside class="widget-area">
                        ...
                        <div class="widget widget_jexa_posts_thumb">
                            ...
                            <article class="item">
                                <NuxtLink to="/blog-details" class="thumb"><span class="fullimage cover bg1" role="img"></span></NuxtLink>
                                <div class="info">
                                    <h4 class="title usmall"><NuxtLink to="/blog-details">Being The Best-Selling Smart Phone This Year</NuxtLink></h4>
                                    <span class="date"><i class="ri-calendar-2-fill"></i> Jan 15, 2020</span>
                                </div>
                            </article>
                            <article class="item">
                                <NuxtLink to="/blog-details" class="thumb"><span class="fullimage cover bg2" role="img"></span></NuxtLink>
                                <div class="info">
                                    <h4 class="title usmall"><NuxtLink to="/blog-details">Love Songs Helped Me Through Heartbreak</NuxtLink></h4>
                                    <span class="date"><i class="ri-calendar-2-fill"></i> Jan 14, 2020</span>
                                </div>
                            </article>
                            <article class="item">
                                <NuxtLink to="/blog-details" class="thumb"><span class="fullimage cover bg3" role="img"></span></NuxtLink>
                                <div class="info">
                                    <h4 class="title usmall"><NuxtLink to="/blog-details">Two Fashion Designers Busy With 2020 Winter Fashion</NuxtLink></h4>
                                    <span class="date"><i class="ri-calendar-2-fill"></i> Jan 13, 2020</span>
                                </div>
                            </article>
                            <article class="item">
                                <NuxtLink to="/blog-details" class="thumb"><span class="fullimage cover bg4" role="img"></span></NuxtLink>
                                <div class="info">
                                    <h4 class="title usmall"><NuxtLink to="/blog-details">Working in the Office is a Tradition For Women</NuxtLink></h4>
                        ...
                        <div class="widget widget_categories">
                            ...
                            <ul>
                                <li><NuxtLink to="/blog-right-sidebar">Business <span class="post-count">(2)</span></NuxtLink></li>
                                <li><NuxtLink to="/blog-right-sidebar">Privacy <span class="post-count">(5)</span></NuxtLink></li>
                                <li><NuxtLink to="/blog-right-sidebar">Technology <span class="post-count">(6)</span></NuxtLink></li>
                                <li><NuxtLink to="/blog-right-sidebar">Tips <span class="post-count">(2)</span></NuxtLink></li>
                                <li><NuxtLink to="/blog-right-sidebar">Log in <span class="post-count">(1)</span></NuxtLink></li>
                                <li><NuxtLink to="/blog-right-sidebar">Uncategorized <span class="post-count">(1)</span></NuxtLink></li>
                            </ul>
                        </div>
