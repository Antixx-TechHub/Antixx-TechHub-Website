        ...
        <div class="container">
            <div class="blog-slides">
                <carousel :autoplay="true" :autoplayTimeout='5000' :loop="true" :paginationEnabled="true"
                    :perPageCustom="[[0, 1], [576, 1], [768, 2], [1200, 4]]" :perPage="1" :navigationEnabled="false"
                    ...
                    <slide>
                        <div class=".single-home-services-item">
                            <div class="sm-features-card">
                                <img src="~/assets/img/home-page/web-development.svg" alt="image" width="60"
                                    height="60">
                                <h3>
                    ...
                    <slide>
                        <div class=".single-home-services-item">
                            <div class="sm-features-card">
                                <img src="~/assets/img/home-page/app-development.svg" alt="image" width="60"
                                    height="60">
                                <h3>
                    ...
                    <slide>
                        <div class=".single-home-services-item">
                            <div class="sm-features-card">
                                <img src="~/assets/img/home-page/seo-services.svg" alt="image" width="60" height="60">
                                <h3>
                    ...
                    <slide>
                        <div class=".single-home-services-item">
                            <div class="sm-features-card">
                                <img src="~/assets/img/home-page/digital-marketing.svg" alt="image" width="60"
                                    height="60">
                                <h3>
                    ...
                    <slide>
                        <div class=".single-home-services-item">
                            <div class="sm-features-card">
                                <img src="~/assets/img/home-page/ui-ux-design.svg" alt="image" width="60" height="60">
                                <h3>
                    ...
                    <slide>
                        <div class=".single-home-services-item">
                            <div class="sm-features-card">
                                <img src="~/assets/img/home-page/branding-marketing.svg" alt="image" width="60"
                                    height="60">
                                <h3>
                    ...
                    <slide>
                        <div class=".single-home-services-item">
                            <div class="sm-features-card">
                                <img src="~/assets/img/home-page/blockchain-development.svg" alt="image" width="60"
                                    height="60">
                                <h3>
